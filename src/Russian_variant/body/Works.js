...
function RuWorkComponent() {
    return (
        <>
            <p className="text-center fw-bolder mb-0 pt-5 fs-1 font-family-sans-serif bg-white container">Примеры нашей работы</p>
...
export default RuWorkComponent;